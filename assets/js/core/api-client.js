// SitePass v23.7.710 Step78 - common api-client core
...
(function(){
  ...
  const storageSignedUrlCacheV523 =
    window.SitePassCoreCache && typeof window.SitePassCoreCache.getMap === 'function'
      ? window.SitePassCoreCache.getMap('storage-signed-url-v523')
      : new Map();
