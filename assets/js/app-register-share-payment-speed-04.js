// SitePass v23.7.323 - speed optimized medium chunk (app-register-share-payment-speed 04/04)
// ---- merged from app-register-share-payment-13.js ----
// SitePass v23.7.323 - app-register-share-payment finer split (13/15)
    ...
    function getPendingRegistration() {
      ...
      try {
        ...
        if (parsed && parsed.item) {
          // v23.7.323: 테스트 기간에는 결제대기 단계가 없어야 합니다.
...
// SitePass v23.7.323 - app-register-share-payment finer split (14/15)
function openPendingRegistrationPaymentScreen(pending) {
      // v23.7.323: 테스트 기간에는 결제화면을 열지 않고 등록완료 처리합니다.
...
// SitePass v23.7.323 - app-register-share-payment finer split (15/15)
