...
function renderWorkerPeopleSection() {
      return '<div class="worker-control-box">' +
        ...
        '<div class="person-auth-panel" data-person-auth-panel="worker" data-auth-code-sent="false" data-pending-verified="false">' +
          ...
          '<div class="auth-mini-note">인부에게 약관/개인정보 동의 링크를 보냅니다. 인부가 자기 휴대폰에서 링크를 열고 필수 동의 체크를 하면 6자리 인증번호가 화면에 표시됩니다. 정식 서비스에서는 NICE/KCB/PASS 본인확인을 별도 연결합니다.</div>' +
          '<div class="person-auth-consent-check">인부 휴대폰으로 동의 링크를 보냅니다. 링크에서 동의하면 인증번호가 표시됩니다. <a href="./terms/person-consent.html?role=worker&v=23.7.354" target="_blank" rel="noopener">약관/개인정보 링크 미리보기</a></div>' +
          '<div class="person-auth-grid three"><button type="button" class="ghost" data-person-auth-send-button onclick="sendPersonAuthCode(\'worker\')">약관동의 링크 문자 발송</button><input type="text" class="hidden" data-person-auth-code placeholder="기사/인부가 동의 후 알려준 6자리 번호 입력" inputmode="numeric" maxlength="6" autocomplete="one-time-code" /><button type="button" class="primary hidden" data-person-auth-verify-button onclick="verifyPersonAuth(\'worker\')">인증하기</button></div>' +
