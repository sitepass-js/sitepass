// SitePass v23.7.317 - speed optimized medium chunk (app-camera-docs-speed 02/04)
// ---- merged from app-camera-docs-05.js ----
// SitePass v23.7.317 - app-camera-docs finer split (05/16)
function renderWorkerPeopleSection() {
    ...
    function addWorkerPerson(type) {
      ...
      // v23.7.317: 인증 후 위에 비어 있는 인부칸이 있는데도 아래에 인부가 하나 더 생기는 문제 보정.
...
// SitePass v23.7.317 - app-camera-docs finer split (06/16)
function renderDocCards() {
    ...
    function promptAdditionalDocPage(card, sourceText) {
      ...
      setTimeout(function() {
        ...
        // v23.7.317: 브라우저 보안상 setTimeout/confirm 뒤 자동 fileInput.click()은
...
// SitePass v23.7.317 - app-camera-docs finer split (07/16)
...
// SitePass v23.7.317 - app-camera-docs finer split (08/16)
