// SitePass v23.7.476-test - 만료날짜 달력 월 이동/날짜 선택 분리
...
try { console.info('[SitePass deploy] v23.7.476-test date-calendar-confirm-on-day-click'); } catch (e) {}
