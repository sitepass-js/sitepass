// SitePass v23.7.524-test - 안정적인 버전 일치 및 반복 새로고침 방지
window.SITEPASS_DB_CONFIG = {
    ...
    // v23.7.524-test: Storage 비공개 + 15분 기간제 signed URL 사용
    storageAccessMode: 'signed',
    storageSignedUrlTtlSeconds: 900,
    appVersion: 'v23.7.524-test',
...
try { console.info('[SitePass deploy] v23.7.524-test stable-no-spfresh'); } catch (e) {}
