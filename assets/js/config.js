// SitePass v23.7.472-test - 첫 화면 체크 후 순차 인증·서류등록
...
try { console.info('[SitePass deploy] v23.7.472-test check-first-sequential-registration'); } catch (e) {}
