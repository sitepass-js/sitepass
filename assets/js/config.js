// SitePass v23.7.505-test - 담당자 서류 복원·상세보기·공유기록 수정
...
try { console.info('[SitePass deploy] v23.7.505-test manager-route-detail-back-fix'); } catch (e) {}
