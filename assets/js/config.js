// SitePass v23.7.496-test - 선택 보내기 저장공간 및 담당자 링크 서버 저장 수정
...
try { console.info('[SitePass deploy] v23.7.496-test manager-share-storage-url-only'); } catch (e) {}
