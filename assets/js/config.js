// SitePass v23.7.499-test - 새로고침 구버전 화면 차단 + 담당자 화면 고정 + 공유자료 복구
...
try { console.info('[SitePass deploy] v23.7.499-test no-old-screen-recipient-lock-share-recovery'); } catch (e) {}
