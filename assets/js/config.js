// SitePass v23.7.483-test - 만료 알림 숫자·방·읽음 통합 및 즉시 테스트
...
try { console.info('[SitePass deploy] v23.7.483-test expiry-test-four-badge-read-fix'); } catch (e) {}
