// SitePass v23.7.495-test - 보관함 즉시 표시 및 백그라운드 서버 동기화
...
try { console.info('[SitePass deploy] v23.7.495-test instant-archive-cache-background-sync'); } catch (e) {}
