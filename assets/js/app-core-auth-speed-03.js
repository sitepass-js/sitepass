...
function formatSitePassSignupJuminDisplay() {
    ...
    async function sendSitePassSignupPhoneCodeTest() {
      ...
      try {
        let signupTermsUrl = '';
        try { signupTermsUrl = new URL('./terms/person-consent.html?role=member&v=23.7.420', window.location.href).href; } catch (e) { signupTermsUrl = './terms/person-consent.html?role=member&v=23.7.420'; }
