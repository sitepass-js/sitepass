// SitePass v23.7.350 - speed optimized medium chunk (app-core-auth-speed 03/04)
// ---- merged from app-core-auth-11.js ----
// SitePass v23.7.350 - app-core-auth finer split (11/19)
...
// SitePass v23.7.350 - app-core-auth finer split (12/19)
...
// SitePass v23.7.350 - app-core-auth finer split (13/19)
...
// SitePass v23.7.350 - app-core-auth finer split (14/19)
...
// SitePass v23.7.350 - app-core-auth finer split (15/19)
function formatSitePassSignupJuminDisplay() {
    ...
    async function sendSitePassSignupPhoneCodeTest() {
      ...
      try {
        let signupTermsUrl = '';
        try { signupTermsUrl = new URL('./terms/person-consent.html?role=member&v=23.7.424', window.location.href).href; } catch (e) { signupTermsUrl = './terms/person-consent.html?role=member&v=23.7.424'; }
