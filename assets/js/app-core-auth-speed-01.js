// SitePass v23.7.333 - speed optimized medium chunk (app-core-auth-speed 01/04)
// ---- merged from app-core-auth-01.js ----
// SitePass v23.7.333 - app-core-auth finer split (01/19)
// SitePass v23.7.333 - app.bundle.js remaining split (01 core/auth/member)
window.__SITEPASS_APP_SPLIT_VERSION = 'v23.7.333';
window.SITEPASS_TEST_NO_PAYMENT_MODE = true; // v23.7.333 테스트 기간에는 결제단계를 건너뜁니다.
// SitePass v23.7.333 - v23.7.290 기준 남은 파일 쪼개기 / 배포 안정화
...
const STORAGE_KEY = 'sitePass_v23_7_7_update_original_corrected';
    ...
    let sitePassRegistrationCompletionBusy = false; // v23.7.333: 테스트 등록완료 처리 중 결제대기/임시저장 안내가 반복으로 뜨는 것을 막습니다.
...
// SitePass v23.7.333 - app-core-auth finer split (02/19)
...
// SitePass v23.7.333 - app-core-auth finer split (03/19)
...
// SitePass v23.7.333 - app-core-auth finer split (04/19)
...
// SitePass v23.7.333 - app-core-auth finer split (05/19)
