// SitePass v23.7.302 - speed optimized medium chunk (app-core-auth-speed 01/04)
// ---- merged from app-core-auth-01.js ----
// SitePass v23.7.302 - app-core-auth finer split (01/19)
// SitePass v23.7.302 - app.bundle.js remaining split (01 core/auth/member)
window.__SITEPASS_APP_SPLIT_VERSION = 'v23.7.302';
window.SITEPASS_TEST_NO_PAYMENT_MODE = true; // v23.7.302 테스트 기간에는 결제단계를 건너뜁니다.
// SitePass v23.7.302 - v23.7.290 기준 남은 파일 쪼개기 / 배포 안정화
...
// SitePass v23.7.302 - app-core-auth finer split (02/19)
...
// SitePass v23.7.302 - app-core-auth finer split (03/19)
...
// SitePass v23.7.302 - app-core-auth finer split (04/19)
...
// SitePass v23.7.302 - app-core-auth finer split (05/19)
