// SitePass v23.7.269 PWA update notice fix - PWA 자동업데이트/서비스워커 전용 파일
...
(function(){
  ...
  function getAppVersion(){
    const rt = runtime();
    return String((rt.getAppVersion && rt.getAppVersion()) || window.SITEPASS_DB_CONFIG?.appVersion || 'v23.7.269').trim() || 'v23.7.269';
  }
  ...
  async function checkAutoUpdate(){
    ...
    // v23.7.269: 브라우저 저장 버전과 현재 실행 버전이 다른 것만으로 자동 새로고침하지 않습니다.
