// SitePass v23.7.349 - speed optimized medium chunk (app-core-auth-speed 02/04)
// ---- merged from app-core-auth-06.js ----
// SitePass v23.7.349 - app-core-auth finer split (06/19)
...
// SitePass v23.7.349 - app-core-auth finer split (07/19)
...
// SitePass v23.7.349 - app-core-auth finer split (08/19)
...
// SitePass v23.7.349 - app-core-auth finer split (09/19)
const SITEPASS_OAUTH_PENDING_KEY = STORAGE_KEY + '_oauth_pending_v23_7_207';
    ...
    // v23.7.349: 중간 청크 로딩 중 아직 뒤쪽 청크 함수가 정의되기 전에 전역에 연결하다가
    ...
    function stabilizeLoginAutofillFields() {
      ...
      if (idInput) {
        ...
        // v23.7.349: Edge Issues 호환성 경고를 줄이기 위해 autocapitalize 속성 동적 부여는 생략합니다.
...
// SitePass v23.7.349 - app-core-auth finer split (10/19)
