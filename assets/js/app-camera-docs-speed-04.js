// SitePass v23.7.319 - speed optimized medium chunk (app-camera-docs-speed 04/04)
// ---- merged from app-camera-docs-13.js ----
// SitePass v23.7.319 - app-camera-docs finer split (13/16)
function trimPaperBorder(canvas) {
    ...
    function isCardQuarterDoc(docKey) {
      ...
      // v23.7.319: 인부 서류키는 workerIdCard_w..._1처럼 uid가 두 번 붙을 수 있습니다.
...
// SitePass v23.7.319 - app-camera-docs finer split (14/16)
...
// SitePass v23.7.319 - app-camera-docs finer split (15/16)
...
// SitePass v23.7.319 - app-camera-docs finer split (16/16)
