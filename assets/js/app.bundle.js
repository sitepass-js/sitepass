// SitePass v23.7.268 - 장비등록 저장 흐름 보조 분리
// v23.7.268에서는 장비등록 필수서류 검증, 등록 item 생성, 결제대기/결제완료 item 생성을 assets/js/equipment-register.js로 분리했습니다.
const STORAGE_KEY = 'sitePass_v23_7_7_update_original_corrected';
    ...
    // v23.7.268: 장비등록 서류정의/검증/저장 item 생성 보조 기능은 assets/js/equipment-register.js로 분리했습니다.
...
${escapePlainTextForAlert(paidItem.equipmentName || '장비')} QR링크가 생성되고 보관함에 저장되었습니다.${paymentSavedLightNote}`);
    ...
    const SITEPASS_APP_VERSION = (window.SITEPASS_DB_CONFIG && window.SITEPASS_DB_CONFIG.appVersion) || 'v23.7.268';
