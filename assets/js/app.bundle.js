// SitePass v23.7.265 split step 12 - 보관함/장비서류 목록 분리
// v23.7.265에서는 보관함 목록/선택/삭제 화면 기능을 assets/js/archive.js로 분리했습니다.
const STORAGE_KEY = 'sitePass_v23_7_7_update_original_corrected';
    ...
    // v23.7.265: 보관함 목록/선택/삭제 기능은 assets/js/archive.js로 분리했습니다.
    function getArchiveModule() {
      return window.SitePassArchive || {};
    }

    // v23.7.265: QR/7일 담당자 공유링크 공통 기능은 assets/js/qr-share.js로 분리했습니다.
