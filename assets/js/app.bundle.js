// SitePass v23.7.256 split step 4 - 관리자 상세관리 분리
// v23.7.256에서는 상세관리/결제/정지/강제탈퇴 조작 함수를 admin-detail.js로 분리했습니다.
const STORAGE_KEY = 'sitePass_v23_7_7_update_original_corrected';
    ...
    // v23.7.256: 분리된 admin-detail.js가 관리자 상세관리 상태를 안전하게 읽고 갱신할 수 있게 하는 브리지입니다.
...
${escapePlainTextForAlert(paidItem.equipmentName || '장비')} QR링크가 생성되고 보관함에 저장되었습니다.${paymentSavedLightNote}`);
    ...
    // v23.7.256: 관리자 상세관리/결제/탈퇴 조작 함수는 assets/js/admin-detail.js로 분리했습니다.
