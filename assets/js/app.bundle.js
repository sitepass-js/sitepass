// SitePass v23.7.266 split step 13 - 장비서류 등록 기준 분리
// v23.7.266에서는 장비/기사/인부 등록 서류 정의와 기본 검증 보조 기능을 assets/js/equipment-register.js로 분리했습니다.
const STORAGE_KEY = 'sitePass_v23_7_7_update_original_corrected';
    ...
    // v23.7.266: 장비/기사/인부 등록 서류 정의와 기본검증 보조 기능은 assets/js/equipment-register.js로 분리했습니다.
...
${escapePlainTextForAlert(paidItem.equipmentName || '장비')} QR링크가 생성되고 보관함에 저장되었습니다.${paymentSavedLightNote}`);
    ...
    const SITEPASS_APP_VERSION = (window.SITEPASS_DB_CONFIG && window.SITEPASS_DB_CONFIG.appVersion) || 'v23.7.266';
