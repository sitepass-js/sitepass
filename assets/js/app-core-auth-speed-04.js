...
function renderAdminContactManager() {
    ...
    /* v23.7.552-test - 강력 새로고침 직전 실제로 보이는 화면을 저장합니다.
    ...
    function showScreen(id, options) {
      // v23.7.552-test: 메인 앱 화면 전환은 회원·관리자·기존 QR 화면만 담당합니다.
      ...
      // v23.7.552-test: 화면 표시 상태는 hidden 클래스 하나로만 관리합니다.
      ...
      if (id === 'contactScreen') {
        // v23.7.552-test: 화면 전환 함수는 contactScreen 표시만 담당합니다.
