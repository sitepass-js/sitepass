// SitePass v23.7.319 - speed optimized medium chunk (app-core-auth-speed 04/04)
// ---- merged from app-core-auth-16.js ----
// SitePass v23.7.319 - app-core-auth finer split (16/19)
...
// SitePass v23.7.319 - app-core-auth finer split (17/19)
function renderAdminContactManager() {
    ...
    function showScreen(id, options) {
      if (sitePassCurrentScreenId === 'registerScreen' && id !== 'registerScreen') {
        // v23.7.319: 등록완료 후 보관함으로 즉시 이동할 때는
...
// SitePass v23.7.319 - app-core-auth finer split (18/19)
...
// SitePass v23.7.319 - app-core-auth finer split (19/19)
function setPersonAuthStatus(kind, text, mode) {
    ...
    function verifyPersonAuth(kind) {
      ...
      // v23.7.319: 인부는 인증 완료 후 사용자가 보통/특수 추가 버튼을 다시 누르지 않도록
