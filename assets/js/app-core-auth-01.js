// SitePass v23.7.296 - app.bundle.js remaining split (01 core/auth/member)
window.__SITEPASS_APP_SPLIT_VERSION = 'v23.7.296';
window.SITEPASS_TEST_NO_PAYMENT_MODE = true; // v23.7.296 테스트 기간에는 결제단계를 건너뜁니다.
// SitePass v23.7.296 - v23.7.290 기준 남은 파일 쪼개기 / 배포 안정화
