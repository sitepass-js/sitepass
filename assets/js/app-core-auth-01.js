// SitePass v23.7.299 - app-core-auth split continue (01/11)
// SitePass v23.7.299 - app.bundle.js remaining split (01 core/auth/member)
window.__SITEPASS_APP_SPLIT_VERSION = 'v23.7.299';
window.SITEPASS_TEST_NO_PAYMENT_MODE = true; // v23.7.299 테스트 기간에는 결제단계를 건너뜁니다.
// SitePass v23.7.299 - v23.7.290 기준 남은 파일 쪼개기 / 배포 안정화
