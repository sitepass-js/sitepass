const SITEPASS_SW_VERSION = 'v23.7.485';
const SITEPASS_CACHE = 'sitepass-v23.7.485';
const SITEPASS_CORE = [
  './',
  './index.html',
  ...
  './assets/js/sitepass-server-member-guard-v463.js',
  './assets/js/sitepass-my-account-v463.js',
  './assets/js/sitepass-chat-v460.js',
  './assets/css/sitepass-chat-v460.css',
  './assets/css/sitepass-my-account-v463.css',
  './assets/css/sitepass-registration-wizard-v472.css',
  './assets/js/sitepass-registration-wizard-v472.js',
