const SITEPASS_SW_VERSION = 'v23.7.498';
const SITEPASS_CACHE = 'sitepass-fast-v23.7.498';
const SITEPASS_PREVIOUS_CACHE = 'sitepass-fast-v23.7.497';
const SITEPASS_OLDER_CACHE = 'sitepass-fast-v23.7.496';
const SITEPASS_SHELL = [
  './index.html',
  './assets/css/style.css?v=23.7.494',
  './assets/js/config.js?v=23.7.498',
  './assets/js/app-register-share-payment-speed-02.js?v=23.7.496',
  './assets/js/app-register-share-payment-speed-03.js?v=23.7.498',
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    // 바로 전 v497과 v496 캐시는 유지하여 변경되지 않은 JS·이미지를 다시 받지 않게 합니다.
...
async function cachedAcrossVersions(request){
  try {
    // 현재 v498 캐시를 먼저 보고, 없을 때 v497·v496 캐시를 차례로 재사용합니다.
